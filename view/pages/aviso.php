<section class="aviso">
  ...
  <div class="aviso__top">

    <h1>Políticas de privacidad</h1>

    <p> 
      Grupo Livark te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios y clientes que puedan ser recabados por la navegación o contratación de servicios a través del sitio Web <b><spam class="txt__blue">www.sorteoslacapital.com</spam></b>
    </p>
  ...
  <div class="aviso__contenido">
    ...
    <p>
      Para navegar por <b><spam class="txt__blue">www.sorteoslacapital.com</spam></b> no es necesario que facilites ningún dato personal. Los casos en los que sí proporcionas tus datos personales son los siguientes:
    </p>
    
    Al contactar a través de los formularios de contacto o enviar un correo electrónico.
    <br><br>
    Al inscribirte en un formulario de suscripción o un boletín que el Titular gestiona con MailChimp. (En caso de existir).
    <br><br>
    Al realizar la compra de boleto para el sorteo que se este generando en ese momento.    
    
    <spam class="aviso__titulos">Finalidad del tratamiento de datos personales</spam>    
    ...
    <p>        
        <b>Formularios de contacto:</b> El Titular solicita datos personales entre los que pueden estar: Nombre y apellidos, dirección de correo electrónico, número de teléfono y dirección de tu sitio Web con la finalidad de responder a tus consultas.
        <br><br>
    ...
    <spam class="aviso__titulos">Seguridad de los datos personales</spam>
    ...
    <p>    
        ...
        <br> <br>    
        El sitio Web está alojado en www.ignilytic.com. La seguridad de tus datos está garantizada, ya que toman todas las medidas de seguridad necesarias para ello. Puedes consultar su política de privacidad para tener más información.
    </p>

    <spam class="aviso__titulos">Presiona el siguiente boton para regresar</spam>    

    <a href="inicio" class="btn__back">Regresar</a>
